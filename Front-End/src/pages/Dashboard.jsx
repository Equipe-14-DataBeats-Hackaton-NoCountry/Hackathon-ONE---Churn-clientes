...
export default function Dashboard() {
  ...
  const engineDados = {
    ...
    "Gênero Masculino": { nome: "Gênero Masculino", acao: "Ajustar campanhas de marketing para segmentação de gênero específica." },
    "Gênero Feminino": { nome: "Gênero Feminino", acao: "Ajustar campanhas de marketing para segmentação de gênero específica." },
    ...
    "País França": { nome: "País França", acao: "Localizar conteúdo e ajustar preços conforme a moeda e região." },
    "País Índia": { nome: "País Índia", acao: "Localizar conteúdo e ajustar preços conforme a moeda e região." },
    "Tipo de Assinatura": { nome: "Tipo de Assinatura", acao: "Sugerir upgrade para planos com mais benefícios." },
    "Assinatura Estudante": { nome: "Assinatura Estudante", acao: "Sugerir upgrade para planos com mais benefícios." },
    ...
    "Anúncios por Semana": { nome: "Anúncios por Semana", acao: "Oferecer teste Premium para aliviar interrupções de áudio." },
    "Uso Offline": { nome: "Uso Offline", acao: "Destacar funcionalidades de download em campanhas educacionais." },
    "Músicas por Minuto": { nome: "Músicas por Minuto", acao: "Sugerir playlists focadas em ritmos específicos (trabalho/treino)." },
    "Intensidade de Anúncios": { nome: "Intensidade de Anúncios", acao: "Reduzir carga de anúncios temporariamente para reter o usuário." },
